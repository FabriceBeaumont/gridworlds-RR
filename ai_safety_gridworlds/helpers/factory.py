...
from environments.absent_supervisor import AbsentSupervisorEnvironment
from environments.boat_race import BoatRaceEnvironment
from environments.conveyor_belt import ConveyorBeltEnvironment
from environments.distributional_shift import DistributionalShiftEnvironment
from environments.friend_foe import FriendFoeEnvironment
from environments.island_navigation import IslandNavigationEnvironment
from environments.rocks_diamonds import RocksDiamondsEnvironment
from environments.safe_interruptibility import SafeInterruptibilityEnvironment
from environments.side_effects_sokoban import SideEffectsSokobanEnvironment
from environments.tomato_watering import TomatoWateringEnvironment
from environments.whisky_gold import WhiskyOrGoldEnvironment
